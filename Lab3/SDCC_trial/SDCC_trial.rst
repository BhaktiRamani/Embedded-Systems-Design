      ...
      000003 02 00 94         [24]  329 	ljmp	_main
      ...
      000062                        344 _putchar:
                           ...
                           000001   351 	ar1 = 0x01
                           000000   352 	ar0 = 0x00
      000062 AF 82            [24]  353 	mov	r7,dpl
                                    354 ;	SDCC_trial.c:11: while(!TI);
      000064                        355 00101$:
      000064 30 99 FD         [24]  356 	jnb	_TI,00101$
                                    357 ;	SDCC_trial.c:12: while(TI==0);
      000067                        358 00104$:
      000067 30 99 FD         [24]  359 	jnb	_TI,00104$
                                    360 ;	SDCC_trial.c:13: while((SCON & 0x02) == 0);
      00006A                        361 00107$:
      00006A E5 98            [12]  362 	mov	a,_SCON
      00006C 30 E1 FB         [24]  363 	jnb	acc.1,00107$
                                    364 ;	SDCC_trial.c:14: TI = 0;
                                    365 ;	assignBit
      00006F C2 99            [12]  366 	clr	_TI
                                    367 ;	SDCC_trial.c:15: SBUF = c;
      000071 8F 99            [24]  368 	mov	_SBUF,r7
                                    369 ;	SDCC_trial.c:16: }
      000073 22               [24]  370 	ret
                                    371 ;------------------------------------------------------------
      ...
      000074 75 98 50         [24]  380 	mov	_SCON,#0x50
                                    381 ;	SDCC_trial.c:20: TMOD = 0x20;
      000077 75 89 20         [24]  382 	mov	_TMOD,#0x20
                                    383 ;	SDCC_trial.c:21: TH1 = 0xFA;
      00007A 75 8D FA         [24]  384 	mov	_TH1,#0xfa
                                    385 ;	SDCC_trial.c:22: TL1 = 0xFA;
      00007D 75 8B FA         [24]  386 	mov	_TL1,#0xfa
                                    387 ;	SDCC_trial.c:23: TR1 = 1;
                                    388 ;	assignBit
      000080 D2 8E            [12]  389 	setb	_TR1
                                    390 ;	SDCC_trial.c:24: }
      000082 22               [24]  391 	ret
                                    392 ;------------------------------------------------------------
      ...
      000083                        401 00101$:
      000083 30 98 FD         [24]  402 	jnb	_RI,00101$
                                    403 ;	SDCC_trial.c:28: while((SCON & 0x01) == 0);
      000086                        404 00104$:
      000086 E5 98            [12]  405 	mov	a,_SCON
      000088 30 E0 FB         [24]  406 	jnb	acc.0,00104$
                                    407 ;	SDCC_trial.c:29: while(RI == 0);
      00008B                        408 00107$:
                                    409 ;	SDCC_trial.c:30: RI = 0;
                                    410 ;	assignBit
      00008B 10 98 02         [24]  411 	jbc	_RI,00130$
      00008E 80 FB            [24]  412 	sjmp	00107$
      000090                        413 00130$:
                                    414 ;	SDCC_trial.c:31: return SBUF;
      000090 85 99 82         [24]  415 	mov	dpl,_SBUF
                                    416 ;	SDCC_trial.c:32: }
      000093 22               [24]  417 	ret
                                    418 ;------------------------------------------------------------
      ...
      000094 12 00 74         [24]  429 	lcall	_uart
                                    430 ;	SDCC_trial.c:38: while(1)
      000097                        431 00102$:
                                    432 ;	SDCC_trial.c:40: recieved = getchar();
      000097 12 00 83         [24]  433 	lcall	_getchar
                                    434 ;	SDCC_trial.c:41: putchar(recieved);
      00009A 12 00 62         [24]  435 	lcall	_putchar
                                    436 ;	SDCC_trial.c:43: }
      00009D 80 F8            [24]  437 	sjmp	00102$
                                    438 	.area CSEG    (CODE)
                                    439 	.area CONST   (CODE)
                                    440 	.area XINIT   (CODE)
