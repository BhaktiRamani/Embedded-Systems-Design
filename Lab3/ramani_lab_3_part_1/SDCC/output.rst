      ...
      000000                        128 	.org 0x0000
                           0000E0   129 _ACC	=	0x00e0
                           0000F0   130 _B	=	0x00f0
                           000083   131 _DPH	=	0x0083
                           000083   132 _DP0H	=	0x0083
                           000082   133 _DPL	=	0x0082
                           000082   134 _DP0L	=	0x0082
      ...
      000000                        157 	.org 0x0000
                           0000F0   158 _BREG_F0	=	0x00f0
                           0000F1   159 _BREG_F1	=	0x00f1
                           0000F2   160 _BREG_F2	=	0x00f2
                           0000F3   161 _BREG_F3	=	0x00f3
                           0000F4   162 _BREG_F4	=	0x00f4
                           0000F5   163 _BREG_F5	=	0x00f5
                           0000F6   164 _BREG_F6	=	0x00f6
                           0000F7   165 _BREG_F7	=	0x00f7
                           0000A8   166 _EX0	=	0x00a8
                           0000A9   167 _ET0	=	0x00a9
                           0000AA   168 _EX1	=	0x00aa
                           0000AB   169 _ET1	=	0x00ab
                           0000AC   170 _ES	=	0x00ac
                           0000AF   171 _EA	=	0x00af
                           0000B8   172 _PX0	=	0x00b8
                           0000B9   173 _PT0	=	0x00b9
                           0000BA   174 _PX1	=	0x00ba
                           0000BB   175 _PT1	=	0x00bb
                           ...
                           0000B0   210 _RXD0	=	0x00b0
                           0000B1   211 _TXD	=	0x00b1
                           0000B1   212 _TXD0	=	0x00b1
      ...
      000008                        261 	.ds	1
                                    ...
                                    304 ;--------------------------------------------------------
                                    305 	.area HOME    (CODE)
      002000                        306 __interrupt_vect:
      002000 02 20 06         [24]  307 	ljmp	__sdcc_gsinit_startup
                                    308 ;--------------------------------------------------------
      ...
      00205F 02 20 03         [24]  322 	ljmp	__sdcc_program_startup
                                    323 ;--------------------------------------------------------
                                    324 ; Home
                                    325 ;--------------------------------------------------------
                                    326 	.area HOME    (CODE)
                                    327 	.area HOME    (CODE)
      002003                        328 __sdcc_program_startup:
      002003 02 20 94         [24]  329 	ljmp	_main
                                    ...
                                    334 	.area CSEG    (CODE)
                                    335 ;------------------------------------------------------------
                                    336 ;Allocation info for local variables in function 'putchar'
                                    337 ;------------------------------------------------------------
                                    338 ;c                         Allocated to registers r7 
                                    339 ;------------------------------------------------------------
                                    340 ;	SDCC_trial.c:9: void putchar(char c)
                                    341 ;	-----------------------------------------
                                    342 ;	 function putchar
                                    343 ;	-----------------------------------------
      002062                        344 _putchar:
                           000007   345 	ar7 = 0x07
                           000006   346 	ar6 = 0x06
                           ...
                           000001   351 	ar1 = 0x01
                           000000   352 	ar0 = 0x00
      002062 AF 82            [24]  353 	mov	r7, dpl
                                    354 ;	SDCC_trial.c:11: while(!TI);
      002064                        355 00101$:
      002064 30 99 FD         [24]  356 	jnb	_TI,00101$
                                    357 ;	SDCC_trial.c:12: while(TI==0);
      002067                        358 00104$:
      002067 30 99 FD         [24]  359 	jnb	_TI,00104$
                                    360 ;	SDCC_trial.c:13: while((SCON & 0x02) == 0);
      00206A                        361 00107$:
      00206A E5 98            [12]  362 	mov	a,_SCON
      00206C 30 E1 FB         [24]  363 	jnb	acc.1,00107$
                                    364 ;	SDCC_trial.c:14: TI = 0;
                                    365 ;	assignBit
      00206F C2 99            [12]  366 	clr	_TI
                                    367 ;	SDCC_trial.c:15: SBUF = c;
      002071 8F 99            [24]  368 	mov	_SBUF,r7
                                    369 ;	SDCC_trial.c:16: }
      002073 22               [24]  370 	ret
                                    371 ;------------------------------------------------------------
                                    372 ;Allocation info for local variables in function 'uart'
                                    373 ;------------------------------------------------------------
                                    374 ;	SDCC_trial.c:17: void uart(void)
                                    375 ;	-----------------------------------------
                                    376 ;	 function uart
                                    377 ;	-----------------------------------------
      002074                        378 _uart:
                                    379 ;	SDCC_trial.c:19: SCON = 0x50;
      002074 75 98 50         [24]  380 	mov	_SCON,#0x50
                                    381 ;	SDCC_trial.c:20: TMOD = 0x20;
      002077 75 89 20         [24]  382 	mov	_TMOD,#0x20
                                    383 ;	SDCC_trial.c:21: TH1 = 0xFA;
      00207A 75 8D FA         [24]  384 	mov	_TH1,#0xfa
                                    385 ;	SDCC_trial.c:22: TL1 = 0xFA;
      00207D 75 8B FA         [24]  386 	mov	_TL1,#0xfa
                                    387 ;	SDCC_trial.c:23: TR1 = 1;
                                    388 ;	assignBit
      002080 D2 8E            [12]  389 	setb	_TR1
                                    390 ;	SDCC_trial.c:24: }
      002082 22               [24]  391 	ret
                                    392 ;------------------------------------------------------------
                                    393 ;Allocation info for local variables in function 'getchar'
                                    394 ;------------------------------------------------------------
                                    395 ;	SDCC_trial.c:25: char getchar(void)
                                    396 ;	-----------------------------------------
                                    397 ;	 function getchar
                                    398 ;	-----------------------------------------
      002083                        399 _getchar:
                                    400 ;	SDCC_trial.c:27: while(!RI);
      002083                        401 00101$:
      002083 30 98 FD         [24]  402 	jnb	_RI,00101$
                                    403 ;	SDCC_trial.c:28: while((SCON & 0x01) == 0);
      002086                        404 00104$:
      002086 E5 98            [12]  405 	mov	a,_SCON
      002088 30 E0 FB         [24]  406 	jnb	acc.0,00104$
                                    407 ;	SDCC_trial.c:29: while(RI == 0);
      00208B                        408 00107$:
                                    409 ;	SDCC_trial.c:30: RI = 0;
                                    410 ;	assignBit
      00208B 10 98 02         [24]  411 	jbc	_RI,00138$
      00208E 80 FB            [24]  412 	sjmp	00107$
      002090                        413 00138$:
                                    414 ;	SDCC_trial.c:31: return SBUF;
      002090 85 99 82         [24]  415 	mov	dpl, _SBUF
                                    416 ;	SDCC_trial.c:32: }
      002093 22               [24]  417 	ret
                                    418 ;------------------------------------------------------------
                                    419 ;Allocation info for local variables in function 'main'
                                    420 ;------------------------------------------------------------
                                    421 ;recieved                  Allocated to registers 
                                    422 ;------------------------------------------------------------
                                    423 ;	SDCC_trial.c:34: void main(void)
                                    424 ;	-----------------------------------------
                                    425 ;	 function main
                                    426 ;	-----------------------------------------
      002094                        427 _main:
                                    428 ;	SDCC_trial.c:37: uart();
      002094 12 20 74         [24]  429 	lcall	_uart
                                    430 ;	SDCC_trial.c:38: while(1)
      002097                        431 00102$:
                                    432 ;	SDCC_trial.c:40: recieved = getchar();
      002097 12 20 83         [24]  433 	lcall	_getchar
                                    434 ;	SDCC_trial.c:41: putchar(recieved);
      00209A 12 20 62         [24]  435 	lcall	_putchar
                                    436 ;	SDCC_trial.c:43: }
      00209D 80 F8            [24]  437 	sjmp	00102$
                                    438 	.area CSEG    (CODE)
                                    439 	.area CONST   (CODE)
                                    440 	.area XINIT   (CODE)
