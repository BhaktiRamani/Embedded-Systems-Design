      ...
      000014                        461 	.ds	1
                                    ...
                                    482 ;--------------------------------------------------------
                                    483 	.area XSEG    (XDATA)
      000400                        484 _putchar_charToSend_65536_13:
      000400                        485 	.ds 2
      000402                        486 _main_i_196608_21:
      000402                        487 	.ds 2
                                    488 ;--------------------------------------------------------
      ...
      005003 02 50 AB         [24]  533 	ljmp	_main
                                    ...
                                    538 	.area CSEG    (CODE)
                                    539 ;------------------------------------------------------------
                                    540 ;Allocation info for local variables in function 'putchar'
                                    541 ;------------------------------------------------------------
                                    542 ;charToSend                Allocated with name '_putchar_charToSend_65536_13'
                                    543 ;------------------------------------------------------------
                                    544 ;	watchdog.c:38: int putchar(int charToSend) {
                                    545 ;	-----------------------------------------
                                    546 ;	 function putchar
                                    547 ;	-----------------------------------------
      005062                        548 _putchar:
                           000007   549 	ar7 = 0x07
                           000006   550 	ar6 = 0x06
                           ...
                           000001   555 	ar1 = 0x01
                           000000   556 	ar0 = 0x00
      005062 AF 83            [24]  557 	mov	r7,dph
      005064 E5 82            [12]  558 	mov	a,dpl
      005066 90 04 00         [24]  559 	mov	dptr,#_putchar_charToSend_65536_13
      005069 F0               [24]  560 	movx	@dptr,a
      00506A EF               [12]  561 	mov	a,r7
      00506B A3               [24]  562 	inc	dptr
      00506C F0               [24]  563 	movx	@dptr,a
                                    564 ;	watchdog.c:39: SBUF = charToSend;  // Send character to serial buffer
      00506D 90 04 00         [24]  565 	mov	dptr,#_putchar_charToSend_65536_13
      005070 E0               [24]  566 	movx	a,@dptr
      005071 FE               [12]  567 	mov	r6,a
      005072 A3               [24]  568 	inc	dptr
      005073 E0               [24]  569 	movx	a,@dptr
      005074 FF               [12]  570 	mov	r7,a
      005075 8E 99            [24]  571 	mov	_SBUF,r6
                                    572 ;	watchdog.c:40: while (!TI);        // Wait for transmission to complete
      005077                        573 00101$:
                                    574 ;	watchdog.c:41: TI = 0;            // Clear transmission interrupt flag
                                    575 ;	assignBit
      005077 10 99 02         [24]  576 	jbc	_TI,00114$
      00507A 80 FB            [24]  577 	sjmp	00101$
      00507C                        578 00114$:
                                    579 ;	watchdog.c:42: return charToSend;
      00507C 8E 82            [24]  580 	mov	dpl,r6
      00507E 8F 83            [24]  581 	mov	dph,r7
                                    582 ;	watchdog.c:43: }
      005080 22               [24]  583 	ret
                                    584 ;------------------------------------------------------------
                                    585 ;Allocation info for local variables in function 'getchar'
                                    586 ;------------------------------------------------------------
                                    587 ;	watchdog.c:49: int getchar(void)
                                    588 ;	-----------------------------------------
                                    589 ;	 function getchar
                                    590 ;	-----------------------------------------
      005081                        591 _getchar:
                                    592 ;	watchdog.c:51: while (!RI);        // Wait for reception to complete
      005081                        593 00101$:
                                    594 ;	watchdog.c:52: RI = 0;            // Clear reception interrupt flag
                                    595 ;	assignBit
      005081 10 98 02         [24]  596 	jbc	_RI,00114$
      005084 80 FB            [24]  597 	sjmp	00101$
      005086                        598 00114$:
                                    599 ;	watchdog.c:53: return SBUF;       // Return received character
      005086 AE 99            [24]  600 	mov	r6,_SBUF
      005088 7F 00            [12]  601 	mov	r7,#0x00
      00508A 8E 82            [24]  602 	mov	dpl,r6
      00508C 8F 83            [24]  603 	mov	dph,r7
                                    604 ;	watchdog.c:54: }
      00508E 22               [24]  605 	ret
                                    606 ;------------------------------------------------------------
                                    607 ;Allocation info for local variables in function 'enable_wdt'
                                    608 ;------------------------------------------------------------
                                    609 ;	watchdog.c:55: void enable_wdt()
                                    610 ;	-----------------------------------------
                                    611 ;	 function enable_wdt
                                    612 ;	-----------------------------------------
      00508F                        613 _enable_wdt:
                                    614 ;	watchdog.c:57: printf("WARCHDOG\n\r");
      00508F 74 8F            [12]  615 	mov	a,#___str_0
      005091 C0 E0            [24]  616 	push	acc
      005093 74 5B            [12]  617 	mov	a,#(___str_0 >> 8)
      005095 C0 E0            [24]  618 	push	acc
      005097 74 80            [12]  619 	mov	a,#0x80
      005099 C0 E0            [24]  620 	push	acc
      00509B 12 51 2D         [24]  621 	lcall	_printf
      00509E 15 81            [12]  622 	dec	sp
      0050A0 15 81            [12]  623 	dec	sp
      0050A2 15 81            [12]  624 	dec	sp
                                    625 ;	watchdog.c:59: WDTRST = 0x1E;
      0050A4 75 A6 1E         [24]  626 	mov	_WDTRST,#0x1e
                                    627 ;	watchdog.c:60: WDTRST = 0xE1;
      0050A7 75 A6 E1         [24]  628 	mov	_WDTRST,#0xe1
                                    629 ;	watchdog.c:61: }
      0050AA 22               [24]  630 	ret
                                    631 ;------------------------------------------------------------
                                    632 ;Allocation info for local variables in function 'main'
                                    633 ;------------------------------------------------------------
                                    634 ;i                         Allocated with name '_main_i_196608_21'
                                    635 ;------------------------------------------------------------
                                    636 ;	watchdog.c:63: void main(void)
                                    637 ;	-----------------------------------------
                                    638 ;	 function main
                                    639 ;	-----------------------------------------
      0050AB                        640 _main:
                                    641 ;	watchdog.c:65: enable_wdt();  // Start the WDT
      0050AB 12 50 8F         [24]  642 	lcall	_enable_wdt
                                    643 ;	watchdog.c:69: printf("- - - -");
      0050AE 74 9A            [12]  644 	mov	a,#___str_1
      0050B0 C0 E0            [24]  645 	push	acc
      0050B2 74 5B            [12]  646 	mov	a,#(___str_1 >> 8)
      0050B4 C0 E0            [24]  647 	push	acc
      0050B6 74 80            [12]  648 	mov	a,#0x80
      0050B8 C0 E0            [24]  649 	push	acc
      0050BA 12 51 2D         [24]  650 	lcall	_printf
      0050BD 15 81            [12]  651 	dec	sp
      0050BF 15 81            [12]  652 	dec	sp
      0050C1 15 81            [12]  653 	dec	sp
                                    654 ;	watchdog.c:71: for ( volatile int i = 0; i < 50000; i++) {}  // Simulate delay
      0050C3 90 04 02         [24]  655 	mov	dptr,#_main_i_196608_21
      0050C6 E4               [12]  656 	clr	a
      0050C7 F0               [24]  657 	movx	@dptr,a
      0050C8 A3               [24]  658 	inc	dptr
      0050C9 F0               [24]  659 	movx	@dptr,a
      0050CA                        660 00105$:
      0050CA 90 04 02         [24]  661 	mov	dptr,#_main_i_196608_21
      0050CD E0               [24]  662 	movx	a,@dptr
      0050CE FE               [12]  663 	mov	r6,a
      0050CF A3               [24]  664 	inc	dptr
      0050D0 E0               [24]  665 	movx	a,@dptr
      0050D1 FF               [12]  666 	mov	r7,a
      0050D2 90 04 02         [24]  667 	mov	dptr,#_main_i_196608_21
      0050D5 74 01            [12]  668 	mov	a,#0x01
      0050D7 2E               [12]  669 	add	a,r6
      0050D8 F0               [24]  670 	movx	@dptr,a
      0050D9 E4               [12]  671 	clr	a
      0050DA 3F               [12]  672 	addc	a,r7
      0050DB A3               [24]  673 	inc	dptr
      0050DC F0               [24]  674 	movx	@dptr,a
                                    675 ;	watchdog.c:76: }
      0050DD 80 EB            [24]  676 	sjmp	00105$
                                    677 	.area CSEG    (CODE)
                                    678 	.area CONST   (CODE)
                                    679 	.area CONST   (CODE)
      005B8F                        680 ___str_0:
      005B8F 57 41 52 43 48 44 4F   681 	.ascii "WARCHDOG"
             47
      005B97 0A                     682 	.db 0x0a
      005B98 0D                     683 	.db 0x0d
      005B99 00                     684 	.db 0x00
                                    685 	.area CSEG    (CODE)
                                    686 	.area CONST   (CODE)
      005B9A                        687 ___str_1:
      005B9A 2D 20 2D 20 2D 20 2D   688 	.ascii "- - - -"
      005BA1 00                     689 	.db 0x00
                                    690 	.area CSEG    (CODE)
                                    691 	.area XINIT   (CODE)
