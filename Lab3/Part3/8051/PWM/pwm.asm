...
;	pwm.c:48: printf("PCA MODE : PWM\n\r");
	...
	dec	sp
	dec	sp
;	pwm.c:50: CKCON0 |= 0x01;
	orl	_CKCON0,#0x01
;	pwm.c:51: printf("X2 mode initialized\n\r");
	mov	a,#___str_2
	push	acc
	mov	a,#(___str_2 >> 8)
	push	acc
...
;	pwm.c:63: while(1)
00114$:
;	pwm.c:65: char command = getchar();
	lcall	_getchar
	mov	r6,dpl
	mov	r7,dph
;	pwm.c:66: if(command == 'R')
	cjne	r6,#0x52,00102$
;	pwm.c:69: pwm_start();
	push	ar6
	lcall	_pwm_start
...
;	pwm.c:88: idle_mode();
	...
	pop	ar6
00110$:
;	pwm.c:90: if(command == 'P')
	cjne	r6,#0x50,00114$
;	pwm.c:92: power_down_mode();
...
;	pwm.c:131: CH = 0X00;
	mov	_CH,#0x00
;	pwm.c:133: CCAP0L = 0X1C;
	mov	_CCAP0L,#0x1c
;	pwm.c:134: CCAP0H = 0X1C;
	mov	_CCAP0H,#0x1c
;	pwm.c:135: CCAPM0 = 0X42;
	mov	_CCAPM0,#0x42
;	pwm.c:136: }
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	pwm.c:138: void pwm_start()
;	-----------------------------------------
;	 function pwm_start
;	-----------------------------------------
_pwm_start:
;	pwm.c:140: printf("PWM START\n\r");
	mov	a,#___str_14
	push	acc
	mov	a,#(___str_14 >> 8)
	push	acc
...
;------------------------------------------------------------
;	pwm.c:144: void pwm_stop()
;	-----------------------------------------
;	 function pwm_stop
;	-----------------------------------------
_pwm_stop:
;	pwm.c:146: printf("PWM STOP\n\r");
	mov	a,#___str_15
	push	acc
	mov	a,#(___str_15 >> 8)
	push	acc
