      ...
      000008                        458 	.ds	1
                                    ...
                                    501 ;--------------------------------------------------------
                                    502 	.area HOME    (CODE)
      004000                        503 __interrupt_vect:
      004000 02 40 06         [24]  504 	ljmp	__sdcc_gsinit_startup
                                    505 ;--------------------------------------------------------
      ...
      00405F 02 40 03         [24]  519 	ljmp	__sdcc_program_startup
                                    520 ;--------------------------------------------------------
                                    521 ; Home
                                    522 ;--------------------------------------------------------
                                    523 	.area HOME    (CODE)
                                    524 	.area HOME    (CODE)
      004003                        525 __sdcc_program_startup:
      004003 02 40 75         [24]  526 	ljmp	_main
                                    ...
                                    531 	.area CSEG    (CODE)
                                    532 ;------------------------------------------------------------
                                    533 ;Allocation info for local variables in function 'init_PCA_HSO'
                                    534 ;------------------------------------------------------------
                                    535 ;	high_speed_output.c:12: void init_PCA_HSO(void) {
                                    536 ;	-----------------------------------------
                                    537 ;	 function init_PCA_HSO
                                    538 ;	-----------------------------------------
      004062                        539 _init_PCA_HSO:
                           000007   540 	ar7 = 0x07
                           000006   541 	ar6 = 0x06
                           000005   542 	ar5 = 0x05
                           000004   543 	ar4 = 0x04
                           ...
                           000001   546 	ar1 = 0x01
                           000000   547 	ar0 = 0x00
                                    548 ;	high_speed_output.c:13: CMOD = 0x02;     // Fclk/2 freq set for PCA mode
      004062 75 D9 02         [24]  549 	mov	_CMOD,#0x02
                                    550 ;	high_speed_output.c:14: CCAPM0 = 0x4C;   // Compare mode + HSO, no interrupt
      004065 75 DA 4C         [24]  551 	mov	_CCAPM0,#0x4c
                                    552 ;	high_speed_output.c:15: CL = 0x00;       // Clear PCA counter
      004068 75 E9 00         [24]  553 	mov	_CL,#0x00
                                    554 ;	high_speed_output.c:16: CH = 0x00;
      00406B 75 F9 00         [24]  555 	mov	_CH,#0x00
                                    556 ;	high_speed_output.c:19: CCAP0L = 0xFF;   // Load compare low byte
      00406E 75 EA FF         [24]  557 	mov	_CCAP0L,#0xff
                                    558 ;	high_speed_output.c:20: CCAP0H = 0xFF;   // Load compare high byte
      004071 75 FA FF         [24]  559 	mov	_CCAP0H,#0xff
                                    560 ;	high_speed_output.c:21: }
      004074 22               [24]  561 	ret
                                    562 ;------------------------------------------------------------
                                    563 ;Allocation info for local variables in function 'main'
                                    564 ;------------------------------------------------------------
                                    565 ;	high_speed_output.c:23: void main(void) {
                                    566 ;	-----------------------------------------
                                    567 ;	 function main
                                    568 ;	-----------------------------------------
      004075                        569 _main:
                                    570 ;	high_speed_output.c:25: CCON = 0x40;
      004075 75 D8 40         [24]  571 	mov	_CCON,#0x40
                                    572 ;	high_speed_output.c:26: init_PCA_HSO();
      004078 12 40 62         [24]  573 	lcall	_init_PCA_HSO
                                    574 ;	high_speed_output.c:28: while(1) {
      00407B                        575 00104$:
                                    576 ;	high_speed_output.c:30: if(CCAP0L != 0xFF)
      00407B 74 FF            [12]  577 	mov	a,#0xff
      00407D B5 EA 02         [24]  578 	cjne	a,_CCAP0L,00116$
      004080 80 F9            [24]  579 	sjmp	00104$
      004082                        580 00116$:
                                    581 ;	high_speed_output.c:32: CCAP0L = 0xFF;
      004082 75 EA FF         [24]  582 	mov	_CCAP0L,#0xff
                                    583 ;	high_speed_output.c:33: CCAP0H = 0xFF;
      004085 75 FA FF         [24]  584 	mov	_CCAP0H,#0xff
                                    585 ;	high_speed_output.c:36: }
      004088 80 F1            [24]  586 	sjmp	00104$
                                    587 	.area CSEG    (CODE)
                                    588 	.area CONST   (CODE)
                                    589 	.area XINIT   (CODE)
