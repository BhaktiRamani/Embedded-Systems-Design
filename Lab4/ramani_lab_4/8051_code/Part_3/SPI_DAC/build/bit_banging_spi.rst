                                    ...
                                    206 	.globl _SP
                                    207 	.globl _P0
                                    208 	.globl _bit_bang_spi
                                    209 	.globl _bit_bang_spi_init
                                    210 	.globl _bit_bang_spi_write
                                    211 ;--------------------------------------------------------
      ...
      000000                        421 	.ds 8
                                    ...
                                    448 ;--------------------------------------------------------
                                    449 	.area XSEG    (XDATA)
      000400                        450 _bit_bang_spi_number_65536_17:
      000400                        451 	.ds 1
      000401                        452 _bit_bang_spi_write_data_65536_22:
      000401                        453 	.ds 2
                                    454 ;--------------------------------------------------------
                                    ...
                                    487 	.area CSEG    (CODE)
                                    488 ;------------------------------------------------------------
                                    489 ;Allocation info for local variables in function 'bit_bang_spi'
                                    490 ;------------------------------------------------------------
                                    491 ;number                    Allocated with name '_bit_bang_spi_number_65536_17'
                                    492 ;------------------------------------------------------------
                                    493 ;	src/bit_banging_spi.c:7: void bit_bang_spi(unsigned char number)
                                    494 ;	-----------------------------------------
                                    495 ;	 function bit_bang_spi
                                    496 ;	-----------------------------------------
      002062                        497 _bit_bang_spi:
                           000007   498 	ar7 = 0x07
                           000006   499 	ar6 = 0x06
                           000005   500 	ar5 = 0x05
                           000004   501 	ar4 = 0x04
                           ...
                           000001   504 	ar1 = 0x01
                           000000   505 	ar0 = 0x00
      002062 E5 82            [12]  506 	mov	a,dpl
      002064 90 04 00         [24]  507 	mov	dptr,#_bit_bang_spi_number_65536_17
      002067 F0               [24]  508 	movx	@dptr,a
                                    509 ;	src/bit_banging_spi.c:9: while(number > 0)
      002068                        510 00101$:
      002068 90 04 00         [24]  511 	mov	dptr,#_bit_bang_spi_number_65536_17
      00206B E0               [24]  512 	movx	a,@dptr
      00206C FF               [12]  513 	mov	r7,a
      00206D E0               [24]  514 	movx	a,@dptr
      00206E 60 24            [24]  515 	jz	00104$
                                    516 ;	src/bit_banging_spi.c:12: bit_bang_spi_write(TEST_DATA);
      002070 90 1F F0         [24]  517 	mov	dptr,#0x1ff0
      002073 C0 07            [24]  518 	push	ar7
      002075 12 20 9F         [24]  519 	lcall	_bit_bang_spi_write
                                    520 ;	src/bit_banging_spi.c:13: delay_ms(DELAY_PERIOD);
      002078 90 01 F4         [24]  521 	mov	dptr,#0x01f4
      00207B 12 20 E9         [24]  522 	lcall	_delay_ms
                                    523 ;	src/bit_banging_spi.c:14: bit_bang_spi_write(IDLE_DATA);
      00207E 90 10 00         [24]  524 	mov	dptr,#0x1000
      002081 12 20 9F         [24]  525 	lcall	_bit_bang_spi_write
                                    526 ;	src/bit_banging_spi.c:15: delay_ms(DELAY_PERIOD);
      002084 90 01 F4         [24]  527 	mov	dptr,#0x01f4
      002087 12 20 E9         [24]  528 	lcall	_delay_ms
      00208A D0 07            [24]  529 	pop	ar7
                                    530 ;	src/bit_banging_spi.c:16: number = number - 1;
      00208C EF               [12]  531 	mov	a,r7
      00208D 14               [12]  532 	dec	a
      00208E 90 04 00         [24]  533 	mov	dptr,#_bit_bang_spi_number_65536_17
      002091 F0               [24]  534 	movx	@dptr,a
      002092 80 D4            [24]  535 	sjmp	00101$
      002094                        536 00104$:
                                    537 ;	src/bit_banging_spi.c:18: }
      002094 22               [24]  538 	ret
                                    539 ;------------------------------------------------------------
                                    540 ;Allocation info for local variables in function 'bit_bang_spi_init'
                                    541 ;------------------------------------------------------------
                                    542 ;	src/bit_banging_spi.c:20: void bit_bang_spi_init(void) {
                                    543 ;	-----------------------------------------
                                    544 ;	 function bit_bang_spi_init
                                    545 ;	-----------------------------------------
      002095                        546 _bit_bang_spi_init:
                                    547 ;	src/bit_banging_spi.c:21: SPCON = SPI_INIT_VALUE;          /* Clear SPI control register */
      002095 75 C3 00         [24]  548 	mov	_SPCON,#0x00
                                    549 ;	src/bit_banging_spi.c:22: SDA = DATA_HIGH;                 /* Set data line high */
                                    550 ;	assignBit
      002098 D2 97            [12]  551 	setb	_P1_7
                                    552 ;	src/bit_banging_spi.c:23: SCL = CLOCK_LOW;                 /* Set clock line low */
                                    553 ;	assignBit
      00209A C2 96            [12]  554 	clr	_P1_6
                                    555 ;	src/bit_banging_spi.c:24: SS = SLAVE_SELECT_INACTIVE;      /* Set slave select high (inactive) */
                                    556 ;	assignBit
      00209C D2 91            [12]  557 	setb	_P1_1
                                    558 ;	src/bit_banging_spi.c:25: }
      00209E 22               [24]  559 	ret
                                    560 ;------------------------------------------------------------
                                    561 ;Allocation info for local variables in function 'bit_bang_spi_write'
                                    562 ;------------------------------------------------------------
                                    563 ;data                      Allocated with name '_bit_bang_spi_write_data_65536_22'
                                    564 ;i                         Allocated with name '_bit_bang_spi_write_i_65536_23'
                                    565 ;------------------------------------------------------------
                                    566 ;	src/bit_banging_spi.c:27: int bit_bang_spi_write(uint16_t data) {
                                    567 ;	-----------------------------------------
                                    568 ;	 function bit_bang_spi_write
                                    569 ;	-----------------------------------------
      00209F                        570 _bit_bang_spi_write:
      00209F AF 83            [24]  571 	mov	r7,dph
      0020A1 E5 82            [12]  572 	mov	a,dpl
      0020A3 90 04 01         [24]  573 	mov	dptr,#_bit_bang_spi_write_data_65536_22
      0020A6 F0               [24]  574 	movx	@dptr,a
      0020A7 EF               [12]  575 	mov	a,r7
      0020A8 A3               [24]  576 	inc	dptr
      0020A9 F0               [24]  577 	movx	@dptr,a
                                    578 ;	src/bit_banging_spi.c:30: SS = SLAVE_SELECT_ACTIVE;        /* Assert slave select (active low) */
                                    579 ;	assignBit
      0020AA C2 91            [12]  580 	clr	_P1_1
                                    581 ;	src/bit_banging_spi.c:33: for(i = 0; i < SPI_DATA_WIDTH; i++) {
      0020AC 7E 00            [12]  582 	mov	r6,#0x00
      0020AE 7F 00            [12]  583 	mov	r7,#0x00
      0020B0                        584 00102$:
                                    585 ;	src/bit_banging_spi.c:34: SDA = (data & MSB_FIRST_MASK) ? DATA_HIGH : DATA_LOW;    /* MSB first */
      0020B0 90 04 01         [24]  586 	mov	dptr,#_bit_bang_spi_write_data_65536_22
      0020B3 E0               [24]  587 	movx	a,@dptr
      0020B4 FC               [12]  588 	mov	r4,a
      0020B5 A3               [24]  589 	inc	dptr
      0020B6 E0               [24]  590 	movx	a,@dptr
      0020B7 FD               [12]  591 	mov	r5,a
      0020B8 23               [12]  592 	rl	a
      0020B9 54 01            [12]  593 	anl	a,#0x01
      0020BB 24 FF            [12]  594 	add	a,#0xff
      0020BD 92 97            [24]  595 	mov	_P1_7,c
                                    596 ;	src/bit_banging_spi.c:35: SCL = CLOCK_HIGH;            /* Clock high */
                                    597 ;	assignBit
      0020BF D2 96            [12]  598 	setb	_P1_6
                                    599 ;	src/bit_banging_spi.c:36: SCL = CLOCK_LOW;             /* Clock low */
                                    600 ;	assignBit
      0020C1 C2 96            [12]  601 	clr	_P1_6
                                    602 ;	src/bit_banging_spi.c:37: data <<= 1;                  /* Shift to next bit */
      0020C3 EC               [12]  603 	mov	a,r4
      0020C4 2C               [12]  604 	add	a,r4
      0020C5 FC               [12]  605 	mov	r4,a
      0020C6 ED               [12]  606 	mov	a,r5
      0020C7 33               [12]  607 	rlc	a
      0020C8 FD               [12]  608 	mov	r5,a
      0020C9 90 04 01         [24]  609 	mov	dptr,#_bit_bang_spi_write_data_65536_22
      0020CC EC               [12]  610 	mov	a,r4
      0020CD F0               [24]  611 	movx	@dptr,a
      0020CE ED               [12]  612 	mov	a,r5
      0020CF A3               [24]  613 	inc	dptr
      0020D0 F0               [24]  614 	movx	@dptr,a
                                    615 ;	src/bit_banging_spi.c:33: for(i = 0; i < SPI_DATA_WIDTH; i++) {
      0020D1 0E               [12]  616 	inc	r6
      0020D2 BE 00 01         [24]  617 	cjne	r6,#0x00,00115$
      0020D5 0F               [12]  618 	inc	r7
      0020D6                        619 00115$:
      0020D6 C3               [12]  620 	clr	c
      0020D7 EE               [12]  621 	mov	a,r6
      0020D8 94 10            [12]  622 	subb	a,#0x10
      0020DA EF               [12]  623 	mov	a,r7
      0020DB 94 00            [12]  624 	subb	a,#0x00
      0020DD 40 D1            [24]  625 	jc	00102$
                                    626 ;	src/bit_banging_spi.c:41: SS = SLAVE_SELECT_INACTIVE;      /* Deassert slave select */
                                    627 ;	assignBit
      0020DF D2 91            [12]  628 	setb	_P1_1
                                    629 ;	src/bit_banging_spi.c:42: SCL = CLOCK_LOW;                 /* Clock low */
                                    630 ;	assignBit
      0020E1 C2 96            [12]  631 	clr	_P1_6
                                    632 ;	src/bit_banging_spi.c:43: SDA = DATA_HIGH;                 /* Data high */
                                    633 ;	assignBit
      0020E3 D2 97            [12]  634 	setb	_P1_7
                                    635 ;	src/bit_banging_spi.c:45: return 0;
      0020E5 90 00 00         [24]  636 	mov	dptr,#0x0000
                                    637 ;	src/bit_banging_spi.c:46: }
      0020E8 22               [24]  638 	ret
                                    639 	.area CSEG    (CODE)
                                    640 	.area CONST   (CODE)
                                    641 	.area XINIT   (CODE)
