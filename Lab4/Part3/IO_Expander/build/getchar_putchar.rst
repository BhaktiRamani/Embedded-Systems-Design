      ...
      000000                        419 	.ds 8
                                    ...
                                    446 ;--------------------------------------------------------
                                    447 	.area XSEG    (XDATA)
      000410                        448 _putchar_charToSend_65536_15:
      000410                        449 	.ds 2
                                    450 ;--------------------------------------------------------
                                    ...
                                    488 ;------------------------------------------------------------
                                    489 ;	src/getchar_putchar.c:10: int putchar(int charToSend) {
                                    490 ;	-----------------------------------------
      ...
      002983                        493 _putchar:
                           ...
                           000001   500 	ar1 = 0x01
                           000000   501 	ar0 = 0x00
      002983 AF 83            [24]  502 	mov	r7,dph
      002985 E5 82            [12]  503 	mov	a,dpl
      002987 90 04 10         [24]  504 	mov	dptr,#_putchar_charToSend_65536_15
      00298A F0               [24]  505 	movx	@dptr,a
      00298B EF               [12]  506 	mov	a,r7
      00298C A3               [24]  507 	inc	dptr
      00298D F0               [24]  508 	movx	@dptr,a
                                    509 ;	src/getchar_putchar.c:11: SBUF = charToSend;       /* Load character into serial buffer */
      00298E 90 04 10         [24]  510 	mov	dptr,#_putchar_charToSend_65536_15
      002991 E0               [24]  511 	movx	a,@dptr
      002992 FE               [12]  512 	mov	r6,a
      002993 A3               [24]  513 	inc	dptr
      002994 E0               [24]  514 	movx	a,@dptr
      002995 FF               [12]  515 	mov	r7,a
      002996 8E 99            [24]  516 	mov	_SBUF,r6
                                    517 ;	src/getchar_putchar.c:12: while (!TI);             /* Wait for transmission completion */
      002998                        518 00101$:
                                    519 ;	src/getchar_putchar.c:13: TI = 0;                  /* Clear transmission flag */
                                    520 ;	assignBit
      002998 10 99 02         [24]  521 	jbc	_TI,00114$
      00299B 80 FB            [24]  522 	sjmp	00101$
      00299D                        523 00114$:
                                    524 ;	src/getchar_putchar.c:14: return charToSend;
      00299D 8E 82            [24]  525 	mov	dpl,r6
      00299F 8F 83            [24]  526 	mov	dph,r7
                                    527 ;	src/getchar_putchar.c:15: }
      0029A1 22               [24]  528 	ret
                                    529 ;------------------------------------------------------------
                                    530 ;Allocation info for local variables in function 'getchar'
                                    531 ;------------------------------------------------------------
                                    532 ;	src/getchar_putchar.c:21: int getchar(void) {
                                    533 ;	-----------------------------------------
                                    534 ;	 function getchar
                                    535 ;	-----------------------------------------
      0029A2                        536 _getchar:
                                    537 ;	src/getchar_putchar.c:22: while (!RI);             /* Wait for reception completion */
      0029A2                        538 00101$:
                                    539 ;	src/getchar_putchar.c:23: RI = 0;                  /* Clear reception flag */
                                    540 ;	assignBit
      0029A2 10 98 02         [24]  541 	jbc	_RI,00114$
      0029A5 80 FB            [24]  542 	sjmp	00101$
      0029A7                        543 00114$:
                                    544 ;	src/getchar_putchar.c:24: return SBUF;             /* Return received character */
      0029A7 AE 99            [24]  545 	mov	r6,_SBUF
      0029A9 7F 00            [12]  546 	mov	r7,#0x00
      0029AB 8E 82            [24]  547 	mov	dpl,r6
      0029AD 8F 83            [24]  548 	mov	dph,r7
                                    549 ;	src/getchar_putchar.c:25: }
      0029AF 22               [24]  550 	ret
                                    551 	.area CSEG    (CODE)
                                    552 	.area CONST   (CODE)
                                    553 	.area XINIT   (CODE)
