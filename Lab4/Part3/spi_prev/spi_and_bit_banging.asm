...
_delay_ms_ms_65536_21:
	.ds 2
_bit_bang_spi_number_65536_43:
	.ds 1
_take_data_input_65537_47:
	.ds 4
_take_data_data_65538_51:
	.ds 1
_mannual_spi_number_65536_54:
	.ds 1
_mannual_spi_dac_value_index_65536_55:
	.ds 2
_mannual_spi_dac_data_65536_55:
	.ds 2
_bit_bang_spi_write_data_65536_65:
	.ds 2
_spi_triangular_wave_number_65536_71:
	.ds 2
_spi_triangular_wave_dac_value_index_65536_72:
	.ds 2
_spi_triangular_wave_dac_data_65536_72:
	.ds 2
_spi_ramp_signal_number_65536_78:
	.ds 2
_spi_ramp_signal_dac_value_index_65536_79:
	.ds 2
_spi_ramp_signal_dac_data_65536_79:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
;	spi_and_bit_banging.c:256: void spi_transmission_stop(void) 
;	-----------------------------------------
;	 function spi_transmission_stop
;	-----------------------------------------
_spi_transmission_stop:
;	spi_and_bit_banging.c:258: SPCON &= ~SPI_ENABLE;          // Disable SPI
	anl	_SPCON,#0xbf
;	spi_and_bit_banging.c:259: }
	ret
;------------------------------------------------------------
...
;	spi_and_bit_banging.c:266: char user_input = getchar();
	lcall	_getchar
	mov	r6,dpl
;	spi_and_bit_banging.c:267: printf("| $ %c\n\r", user_input);
	mov	ar5,r6
	mov	r7,#0x00
	push	ar6
	push	ar5
	...
	add	a,#0xfb
	mov	sp,a
;	spi_and_bit_banging.c:268: printf("\n\r");
	mov	a,#___str_15
	push	acc
	mov	a,#(___str_15 >> 8)
	push	acc
	...
	dec	sp
	pop	ar6
;	spi_and_bit_banging.c:269: switch(user_input)
	cjne	r6,#0x42,00122$
	sjmp	00102$
00122$:
	cjne	r6,#0x4d,00103$
...
;------------------------------------------------------------
;input                     Allocated with name '_take_data_input_65537_47'
;i                         Allocated with name '_take_data_i_65537_47'
...
;	spi_and_bit_banging.c:364: char input[4] = {0};  // Array for 3 hex chars + null terminator
	...
	clr	a
	movx	@dptr,a
	mov	dptr,#(_take_data_input_65537_47 + 0x0001)
	movx	@dptr,a
	mov	dptr,#(_take_data_input_65537_47 + 0x0002)
	movx	@dptr,a
...
;	spi_and_bit_banging.c:384: input[i] = c;
	...
	mov	dpl,a
	mov	a,r7
	addc	a,#(_take_data_input_65537_47 >> 8)
	mov	dph,a
	mov	a,r4
	movx	@dptr,a
...
;------------------------------------------------------------
;number                    Allocated with name '_mannual_spi_number_65536_54'
;dac_value_index           Allocated with name '_mannual_spi_dac_value_index_65536_55'
;dac_data                  Allocated with name '_mannual_spi_dac_data_65536_55'
;high_byte                 Allocated with name '_mannual_spi_high_byte_65536_55'
...
;	spi_and_bit_banging.c:418: int dac_data = 0;
	...
	inc	dptr
	movx	@dptr,a
;	spi_and_bit_banging.c:420: while(number > 0)
00111$:
	mov	dptr,#_mannual_spi_number_65536_54
	movx	a,@dptr
	jnz	00156$
	ret
00156$:
;	spi_and_bit_banging.c:423: for(int i = 0; i<256; i++)
	mov	r6,#0x00
	mov	r7,#0x00
00115$:
	clr	c
	...
	ljmp	00110$
00157$:
;	spi_and_bit_banging.c:426: if(dac_value_index < SINE_MAX_INDEX)
	mov	dptr,#_mannual_spi_dac_value_index_65536_55
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	subb	a,#0x81
	jnc	00102$
;	spi_and_bit_banging.c:430: dac_data = dac_values[dac_value_index];
	mov	a,r4
	add	a,r4
	mov	r4,a
	mov	a,r5
	...
	sjmp	00103$
00102$:
;	spi_and_bit_banging.c:434: dac_value_index = 0;  // Reset index for next cycle
	mov	dptr,#_mannual_spi_dac_value_index_65536_55
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
00103$:
;	spi_and_bit_banging.c:441: ((dac_data >> 4) & 0x0F);
	mov	dptr,#_mannual_spi_dac_data_65536_55
	movx	a,@dptr
	mov	r4,a
	inc	dptr
...
00159$:
	...
	orl	a,#0x10
	mov	r3,a
;	spi_and_bit_banging.c:444: low_byte = (dac_data & 0x0F) << 4;
	anl	ar4,#0x0f
	mov	a,r4
	swap	a
	anl	a,#0xf0
	mov	r5,a
;	spi_and_bit_banging.c:448: P1_1 = 0;  // Select DAC
;	assignBit
	clr	_P1_1
;	spi_and_bit_banging.c:451: SPDAT = high_byte;
	mov	_SPDAT,r3
;	spi_and_bit_banging.c:452: while (!(SPSTA & (1<<7))); 
00104$:
	mov	a,_SPSTA
	jnb	acc.7,00104$
;	spi_and_bit_banging.c:456: SPDAT = low_byte;
	mov	_SPDAT,r5
;	spi_and_bit_banging.c:457: while (!(SPSTA & (1<<7))); 
00107$:
	mov	a,_SPSTA
	jnb	acc.7,00107$
;	spi_and_bit_banging.c:459: P1_1 = 1;  // Deselect DAC
;	assignBit
	setb	_P1_1
;	spi_and_bit_banging.c:461: dac_value_index++;
	mov	dptr,#_mannual_spi_dac_value_index_65536_55
	movx	a,@dptr
	add	a,#0x01
	movx	@dptr,a
...
00162$:
	ljmp	00115$
00110$:
;	spi_and_bit_banging.c:464: number = number - 1;
	mov	dptr,#_mannual_spi_number_65536_54
	movx	a,@dptr
	mov	r7,a
	dec	a
	movx	@dptr,a
;	spi_and_bit_banging.c:466: }
	ljmp	00111$
;------------------------------------------------------------
;Allocation info for local variables in function 'spi_init'
;------------------------------------------------------------
;	spi_and_bit_banging.c:477: void spi_init(void) 
;	-----------------------------------------
;	 function spi_init
;	-----------------------------------------
_spi_init:
;	spi_and_bit_banging.c:498: SPCON |= 0x10;
	orl	_SPCON,#0x10
;	spi_and_bit_banging.c:499: SPCON |= 0x20;
	orl	_SPCON,#0x20
;	spi_and_bit_banging.c:500: SPCON |= 0x40;
	orl	_SPCON,#0x40
;	spi_and_bit_banging.c:507: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'bit_bang_spi_init'
;------------------------------------------------------------
;	spi_and_bit_banging.c:509: void bit_bang_spi_init(void) {
;	-----------------------------------------
;	 function bit_bang_spi_init
;	-----------------------------------------
_bit_bang_spi_init:
;	spi_and_bit_banging.c:510: SPCON = SPI_INIT_VALUE;          /* Clear SPI control register */
	mov	_SPCON,#0x00
;	spi_and_bit_banging.c:511: SDA = DATA_HIGH;                 /* Set data line high */
;	assignBit
	setb	_P1_7
;	spi_and_bit_banging.c:512: SCL = CLOCK_LOW;                 /* Set clock line low */
;	assignBit
	clr	_P1_6
;	spi_and_bit_banging.c:513: SS = SLAVE_SELECT_INACTIVE;      /* Set slave select high (inactive) */
;	assignBit
	setb	_P1_1
;	spi_and_bit_banging.c:514: }
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	spi_and_bit_banging.c:516: int bit_bang_spi_write(uint16_t data) {
;	-----------------------------------------
...
_bit_bang_spi_write:
	...
	inc	dptr
	movx	@dptr,a
;	spi_and_bit_banging.c:519: SS = SLAVE_SELECT_ACTIVE;        /* Assert slave select (active low) */
;	assignBit
	clr	_P1_1
;	spi_and_bit_banging.c:522: for(i = 0; i < SPI_DATA_WIDTH; i++) {
	mov	r6,#0x00
	mov	r7,#0x00
00102$:
;	spi_and_bit_banging.c:523: SDA = (data & MSB_FIRST_MASK) ? DATA_HIGH : DATA_LOW;    /* MSB first */
	mov	dptr,#_bit_bang_spi_write_data_65536_65
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	add	a,#0xff
	mov	_P1_7,c
;	spi_and_bit_banging.c:524: SCL = CLOCK_HIGH;            /* Clock high */
;	assignBit
	setb	_P1_6
;	spi_and_bit_banging.c:525: SCL = CLOCK_LOW;             /* Clock low */
;	assignBit
	clr	_P1_6
;	spi_and_bit_banging.c:526: data <<= 1;                  /* Shift to next bit */
	mov	a,r4
	add	a,r4
	mov	r4,a
	mov	a,r5
...
00115$:
	...
	subb	a,#0x00
	jc	00102$
;	spi_and_bit_banging.c:530: SS = SLAVE_SELECT_INACTIVE;      /* Deassert slave select */
;	assignBit
	setb	_P1_1
;	spi_and_bit_banging.c:531: SCL = CLOCK_LOW;                 /* Clock low */
;	assignBit
	clr	_P1_6
;	spi_and_bit_banging.c:532: SDA = DATA_HIGH;                 /* Data high */
;	assignBit
	setb	_P1_7
;	spi_and_bit_banging.c:534: return 0;
	mov	dptr,#0x0000
...
;------------------------------------------------------------
;	spi_and_bit_banging.c:542: void spi_transmission_start(void)
;	-----------------------------------------
;	 function spi_transmission_start
;	-----------------------------------------
_spi_transmission_start:
;	spi_and_bit_banging.c:544: SPCON |= SPI_ENABLE;           // Enable SPI
	orl	_SPCON,#0x40
;	spi_and_bit_banging.c:545: P1_1 = 0;
;	assignBit
	clr	_P1_1
;	spi_and_bit_banging.c:546: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'spi_triangular_wave'
;------------------------------------------------------------
;number                    Allocated with name '_spi_triangular_wave_number_65536_71'
;dac_value_index           Allocated with name '_spi_triangular_wave_dac_value_index_65536_72'
;dac_data                  Allocated with name '_spi_triangular_wave_dac_data_65536_72'
;high_byte                 Allocated with name '_spi_triangular_wave_high_byte_65536_72'
...
;------------------------------------------------------------
;	spi_and_bit_banging.c:548: void spi_triangular_wave(int number)
;	-----------------------------------------
...
_spi_triangular_wave:
	...
	inc	dptr
	movx	@dptr,a
;	spi_and_bit_banging.c:550: int dac_value_index = 0;
	mov	dptr,#_spi_triangular_wave_dac_value_index_65536_72
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	spi_and_bit_banging.c:551: int dac_data = 0;
	mov	dptr,#_spi_triangular_wave_dac_data_65536_72
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	spi_and_bit_banging.c:553: while(number>0)
	mov	dptr,#_spi_triangular_wave_number_65536_71
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
00111$:
	...
	ljmp	00129$
00157$:
;	spi_and_bit_banging.c:555: for(int i = 0; i<512; i++)
	mov	r4,#0x00
	mov	r5,#0x00
00115$:
	clr	c
	...
	ljmp	00110$
00158$:
;	spi_and_bit_banging.c:558: if(dac_value_index < 512)
	mov	dptr,#_spi_triangular_wave_dac_value_index_65536_72
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	subb	a,#0x82
	jnc	00102$
;	spi_and_bit_banging.c:562: dac_data = trig_dac_values[dac_value_index];
	mov	a,r2
	add	a,r2
	mov	r2,a
	mov	a,r3
	...
	sjmp	00103$
00102$:
;	spi_and_bit_banging.c:566: dac_value_index = 0;  // Reset index for next cycle
	mov	dptr,#_spi_triangular_wave_dac_value_index_65536_72
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
00103$:
;	spi_and_bit_banging.c:573: ((dac_data >> 4) & 0x0F);
	mov	dptr,#_spi_triangular_wave_dac_data_65536_72
	movx	a,@dptr
	mov	r2,a
	inc	dptr
...
00160$:
	...
	orl	a,#0x10
	mov	r1,a
;	spi_and_bit_banging.c:576: low_byte = (dac_data & 0x0F) << 4;
	anl	ar2,#0x0f
	mov	a,r2
	swap	a
	anl	a,#0xf0
	mov	r3,a
;	spi_and_bit_banging.c:580: P1_1 = 0;  // Select DAC
;	assignBit
	clr	_P1_1
;	spi_and_bit_banging.c:583: SPDAT = high_byte;
	mov	_SPDAT,r1
;	spi_and_bit_banging.c:584: while (!(SPSTA & (1<<7))); 
00104$:
	mov	a,_SPSTA
	jnb	acc.7,00104$
;	spi_and_bit_banging.c:588: SPDAT = low_byte;
	mov	_SPDAT,r3
;	spi_and_bit_banging.c:589: while (!(SPSTA & (1<<7))); 
00107$:
	mov	a,_SPSTA
	jnb	acc.7,00107$
;	spi_and_bit_banging.c:591: P1_1 = 1;  // Deselect DAC
;	assignBit
	setb	_P1_1
;	spi_and_bit_banging.c:593: dac_value_index++;
	mov	dptr,#_spi_triangular_wave_dac_value_index_65536_72
	movx	a,@dptr
	add	a,#0x01
	movx	@dptr,a
...
00163$:
	ljmp	00115$
00110$:
;	spi_and_bit_banging.c:596: number = number - 1;
	dec	r6
	cjne	r6,#0xff,00164$
	dec	r7
00164$:
...
00129$:
	...
	inc	dptr
	movx	@dptr,a
;	spi_and_bit_banging.c:599: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'spi_ramp_signal'
;------------------------------------------------------------
;number                    Allocated with name '_spi_ramp_signal_number_65536_78'
;dac_value_index           Allocated with name '_spi_ramp_signal_dac_value_index_65536_79'
;dac_data                  Allocated with name '_spi_ramp_signal_dac_data_65536_79'
;high_byte                 Allocated with name '_spi_ramp_signal_high_byte_65536_79'
;low_byte                  Allocated with name '_spi_ramp_signal_low_byte_65536_79'
;i                         Allocated with name '_spi_ramp_signal_i_196608_81'
;------------------------------------------------------------
;	spi_and_bit_banging.c:601: void spi_ramp_signal(int number)
;	-----------------------------------------
...
_spi_ramp_signal:
	...
	inc	dptr
	movx	@dptr,a
;	spi_and_bit_banging.c:603: int dac_value_index = 0;
	mov	dptr,#_spi_ramp_signal_dac_value_index_65536_79
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	spi_and_bit_banging.c:604: int dac_data = 0;
	mov	dptr,#_spi_ramp_signal_dac_data_65536_79
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	spi_and_bit_banging.c:606: while(number>0)
	mov	dptr,#_spi_ramp_signal_number_65536_78
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
00111$:
	...
	ljmp	00129$
00157$:
;	spi_and_bit_banging.c:608: for(int i = 0; i<256; i++)
	mov	r4,#0x00
	mov	r5,#0x00
00115$:
	clr	c
	...
	ljmp	00110$
00158$:
;	spi_and_bit_banging.c:611: if(dac_value_index < 256)
	mov	dptr,#_spi_ramp_signal_dac_value_index_65536_79
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	subb	a,#0x81
	jnc	00102$
;	spi_and_bit_banging.c:615: dac_data = trig_dac_values[dac_value_index];
	mov	a,r2
	add	a,r2
	mov	r2,a
	mov	a,r3
	...
	sjmp	00103$
00102$:
;	spi_and_bit_banging.c:619: dac_value_index = 0;  // Reset index for next cycle
	mov	dptr,#_spi_ramp_signal_dac_value_index_65536_79
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
00103$:
;	spi_and_bit_banging.c:626: ((dac_data >> 4) & 0x0F);
	mov	dptr,#_spi_ramp_signal_dac_data_65536_79
	movx	a,@dptr
	mov	r2,a
	inc	dptr
...
00160$:
	...
	orl	a,#0x10
	mov	r1,a
;	spi_and_bit_banging.c:629: low_byte = (dac_data & 0x0F) << 4;
	anl	ar2,#0x0f
	mov	a,r2
	swap	a
	anl	a,#0xf0
	mov	r3,a
;	spi_and_bit_banging.c:633: P1_1 = 0;  // Select DAC
;	assignBit
	clr	_P1_1
;	spi_and_bit_banging.c:636: SPDAT = high_byte;
	mov	_SPDAT,r1
;	spi_and_bit_banging.c:637: while (!(SPSTA & (1<<7))); 
00104$:
	mov	a,_SPSTA
	jnb	acc.7,00104$
;	spi_and_bit_banging.c:641: SPDAT = low_byte;
	mov	_SPDAT,r3
;	spi_and_bit_banging.c:642: while (!(SPSTA & (1<<7))); 
00107$:
	mov	a,_SPSTA
	jnb	acc.7,00107$
;	spi_and_bit_banging.c:644: P1_1 = 1;  // Deselect DAC
;	assignBit
	setb	_P1_1
;	spi_and_bit_banging.c:646: dac_value_index++;
	mov	dptr,#_spi_ramp_signal_dac_value_index_65536_79
	movx	a,@dptr
	add	a,#0x01
	movx	@dptr,a
...
00163$:
	ljmp	00115$
00110$:
;	spi_and_bit_banging.c:649: number = number - 1;
	dec	r6
	cjne	r6,#0xff,00164$
	dec	r7
00164$:
