                                    ...
                                    205 	.globl _SP
                                    206 	.globl _P0
                                    207 	.globl _disable_interrupt0
                                    208 	.globl _enable_interrupt0
                                    209 ;--------------------------------------------------------
      ...
      000000                        419 	.ds 8
                                    ...
                                    481 	.area CSEG    (CODE)
                                    482 ;------------------------------------------------------------
                                    483 ;Allocation info for local variables in function 'disable_interrupt0'
                                    484 ;------------------------------------------------------------
                                    485 ;	src/interrupts.c:3: void disable_interrupt0(void)
                                    486 ;	-----------------------------------------
                                    487 ;	 function disable_interrupt0
                                    488 ;	-----------------------------------------
      002B8E                        489 _disable_interrupt0:
                           000007   490 	ar7 = 0x07
                           000006   491 	ar6 = 0x06
                           000005   492 	ar5 = 0x05
                           000004   493 	ar4 = 0x04
                           ...
                           000001   496 	ar1 = 0x01
                           000000   497 	ar0 = 0x00
                                    498 ;	src/interrupts.c:6: IT0 = 0;           // Set INT0 to be edge-triggered
                                    499 ;	assignBit
      002B8E C2 88            [12]  500 	clr	_IT0
                                    501 ;	src/interrupts.c:7: EX0 = 0;          // Enable INT0 interrupt
                                    502 ;	assignBit
      002B90 C2 A8            [12]  503 	clr	_EX0
                                    504 ;	src/interrupts.c:8: EA = 0;           // Enable global interrupts
                                    505 ;	assignBit
      002B92 C2 AF            [12]  506 	clr	_EA
                                    507 ;	src/interrupts.c:9: }
      002B94 22               [24]  508 	ret
                                    509 ;------------------------------------------------------------
                                    510 ;Allocation info for local variables in function 'enable_interrupt0'
                                    511 ;------------------------------------------------------------
                                    512 ;	src/interrupts.c:11: void enable_interrupt0(void)
                                    513 ;	-----------------------------------------
                                    514 ;	 function enable_interrupt0
                                    515 ;	-----------------------------------------
      002B95                        516 _enable_interrupt0:
                                    517 ;	src/interrupts.c:14: IT0 = 1;           // Set INT0 to be edge-triggered
                                    518 ;	assignBit
      002B95 D2 88            [12]  519 	setb	_IT0
                                    520 ;	src/interrupts.c:15: EX0 = 1;          // Enable INT0 interrupt
                                    521 ;	assignBit
      002B97 D2 A8            [12]  522 	setb	_EX0
                                    523 ;	src/interrupts.c:16: EA = 1;           // Enable global interrupts
                                    524 ;	assignBit
      002B99 D2 AF            [12]  525 	setb	_EA
                                    526 ;	src/interrupts.c:17: }
      002B9B 22               [24]  527 	ret
                                    528 	.area CSEG    (CODE)
                                    529 	.area CONST   (CODE)
                                    530 	.area XINIT   (CODE)
