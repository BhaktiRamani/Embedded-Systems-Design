      ...
      000000                        419 	.ds 8
                                    ...
                                    446 ;--------------------------------------------------------
                                    447 	.area XSEG    (XDATA)
      000405                        448 _putchar_charToSend_65536_15:
      000405                        449 	.ds 2
                                    450 ;--------------------------------------------------------
                                    ...
                                    486 ;------------------------------------------------------------
                                    487 ;charToSend                Allocated with name '_putchar_charToSend_65536_15'
                                    488 ;------------------------------------------------------------
                                    489 ;	src/getchar_putchar.c:13: int putchar(int charToSend) {
                                    490 ;	-----------------------------------------
      ...
      00211C                        493 _putchar:
                           ...
                           000001   500 	ar1 = 0x01
                           000000   501 	ar0 = 0x00
      00211C AF 83            [24]  502 	mov	r7,dph
      00211E E5 82            [12]  503 	mov	a,dpl
      002120 90 04 05         [24]  504 	mov	dptr,#_putchar_charToSend_65536_15
      002123 F0               [24]  505 	movx	@dptr,a
      002124 EF               [12]  506 	mov	a,r7
      002125 A3               [24]  507 	inc	dptr
      002126 F0               [24]  508 	movx	@dptr,a
                                    509 ;	src/getchar_putchar.c:14: SBUF = charToSend;       /* Load character into serial buffer */
      002127 90 04 05         [24]  510 	mov	dptr,#_putchar_charToSend_65536_15
      00212A E0               [24]  511 	movx	a,@dptr
      00212B FE               [12]  512 	mov	r6,a
      00212C A3               [24]  513 	inc	dptr
      00212D E0               [24]  514 	movx	a,@dptr
      00212E FF               [12]  515 	mov	r7,a
      00212F 8E 99            [24]  516 	mov	_SBUF,r6
                                    517 ;	src/getchar_putchar.c:15: while (!TI);             /* Wait for transmission completion */
      002131                        518 00101$:
                                    519 ;	src/getchar_putchar.c:16: TI = 0;                  /* Clear transmission flag */
                                    520 ;	assignBit
      002131 10 99 02         [24]  521 	jbc	_TI,00114$
      002134 80 FB            [24]  522 	sjmp	00101$
      002136                        523 00114$:
                                    524 ;	src/getchar_putchar.c:17: return charToSend;
      002136 8E 82            [24]  525 	mov	dpl,r6
      002138 8F 83            [24]  526 	mov	dph,r7
                                    527 ;	src/getchar_putchar.c:18: }
      00213A 22               [24]  528 	ret
                                    529 ;------------------------------------------------------------
                                    530 ;Allocation info for local variables in function 'getchar'
                                    531 ;------------------------------------------------------------
                                    532 ;	src/getchar_putchar.c:24: int getchar(void) {
                                    533 ;	-----------------------------------------
                                    534 ;	 function getchar
                                    535 ;	-----------------------------------------
      00213B                        536 _getchar:
                                    537 ;	src/getchar_putchar.c:25: while (!RI);             /* Wait for reception completion */
      00213B                        538 00101$:
                                    539 ;	src/getchar_putchar.c:26: RI = 0;                  /* Clear reception flag */
                                    540 ;	assignBit
      00213B 10 98 02         [24]  541 	jbc	_RI,00114$
      00213E 80 FB            [24]  542 	sjmp	00101$
      002140                        543 00114$:
                                    544 ;	src/getchar_putchar.c:27: return SBUF;             /* Return received character */
      002140 AE 99            [24]  545 	mov	r6,_SBUF
      002142 7F 00            [12]  546 	mov	r7,#0x00
      002144 8E 82            [24]  547 	mov	dpl,r6
      002146 8F 83            [24]  548 	mov	dph,r7
                                    549 ;	src/getchar_putchar.c:28: }
      002148 22               [24]  550 	ret
                                    551 	.area CSEG    (CODE)
                                    552 	.area CONST   (CODE)
                                    553 	.area XINIT   (CODE)
