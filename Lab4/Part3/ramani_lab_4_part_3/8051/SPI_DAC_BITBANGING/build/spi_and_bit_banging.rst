                                     ...
                                     14 	.globl _take_data
                                     15 	.globl _bit_bang_spi_init
                                     16 	.globl _bit_bang_spi
                                     17 	.globl _spi_init
                                     18 	.globl _mannual_spi
                                     19 	.globl _printf
                                     20 	.globl _CY
                                     21 	.globl _AC
                                     22 	.globl _F0
      ...
      000014                        439 	.ds	1
                                    ...
                                    482 ;--------------------------------------------------------
                                    483 	.area HOME    (CODE)
      002000                        484 __interrupt_vect:
      002000 02 20 06         [24]  485 	ljmp	__sdcc_gsinit_startup
                                    486 ;--------------------------------------------------------
      ...
      00205F 02 20 03         [24]  500 	ljmp	__sdcc_program_startup
                                    501 ;--------------------------------------------------------
                                    502 ; Home
                                    503 ;--------------------------------------------------------
                                    504 	.area HOME    (CODE)
                                    505 	.area HOME    (CODE)
      002003                        506 __sdcc_program_startup:
      002003 02 22 0B         [24]  507 	ljmp	_main
                                    ...
                                    515 ;------------------------------------------------------------
                                    516 ;user_input                Allocated with name '_main_user_input_131072_24'
                                    517 ;result                    Allocated with name '_main_result_196609_26'
                                    518 ;result2                   Allocated with name '_main_result2_196610_27'
                                    519 ;------------------------------------------------------------
                                    520 ;	src/spi_and_bit_banging.c:38: int main(void)
                                    521 ;	-----------------------------------------
                                    522 ;	 function main
                                    523 ;	-----------------------------------------
      00220B                        524 _main:
                           ...
                           000001   531 	ar1 = 0x01
                           000000   532 	ar0 = 0x00
                                    533 ;	src/spi_and_bit_banging.c:40: display_menu();
      00220B 12 22 95         [24]  534 	lcall	_display_menu
                                    535 ;	src/spi_and_bit_banging.c:42: while(1)
      00220E                        536 00105$:
                                    537 ;	src/spi_and_bit_banging.c:44: char user_input = getchar();
      00220E 12 21 3B         [24]  538 	lcall	_getchar
      002211 AE 82            [24]  539 	mov	r6,dpl
                                    540 ;	src/spi_and_bit_banging.c:45: printf("| $ %c\n\r", user_input);
      002213 8E 05            [24]  541 	mov	ar5,r6
      002215 7F 00            [12]  542 	mov	r7,#0x00
      002217 C0 06            [24]  543 	push	ar6
      002219 C0 05            [24]  544 	push	ar5
      00221B C0 07            [24]  545 	push	ar7
      00221D 74 14            [12]  546 	mov	a,#___str_0
      00221F C0 E0            [24]  547 	push	acc
      002221 74 30            [12]  548 	mov	a,#(___str_0 >> 8)
      002223 C0 E0            [24]  549 	push	acc
      002225 74 80            [12]  550 	mov	a,#0x80
      002227 C0 E0            [24]  551 	push	acc
      002229 12 25 B2         [24]  552 	lcall	_printf
      00222C E5 81            [12]  553 	mov	a,sp
      00222E 24 FB            [12]  554 	add	a,#0xfb
      002230 F5 81            [12]  555 	mov	sp,a
                                    556 ;	src/spi_and_bit_banging.c:46: printf("\n\r");
      002232 74 1D            [12]  557 	mov	a,#___str_1
      002234 C0 E0            [24]  558 	push	acc
      002236 74 30            [12]  559 	mov	a,#(___str_1 >> 8)
      002238 C0 E0            [24]  560 	push	acc
      00223A 74 80            [12]  561 	mov	a,#0x80
      00223C C0 E0            [24]  562 	push	acc
      00223E 12 25 B2         [24]  563 	lcall	_printf
      002241 15 81            [12]  564 	dec	sp
      002243 15 81            [12]  565 	dec	sp
      002245 15 81            [12]  566 	dec	sp
      002247 D0 06            [24]  567 	pop	ar6
                                    568 ;	src/spi_and_bit_banging.c:47: switch(user_input)
      002249 BE 42 02         [24]  569 	cjne	r6,#0x42,00121$
      00224C 80 23            [24]  570 	sjmp	00102$
      00224E                        571 00121$:
      00224E BE 4D BD         [24]  572 	cjne	r6,#0x4d,00105$
                                    573 ;	src/spi_and_bit_banging.c:50: spi_init();
      002251 12 22 01         [24]  574 	lcall	_spi_init
                                    575 ;	src/spi_and_bit_banging.c:51: unsigned char result = take_data();
      002254 12 24 10         [24]  576 	lcall	_take_data
                                    577 ;	src/spi_and_bit_banging.c:52: mannual_spi(result);
      002257 12 21 49         [24]  578 	lcall	_mannual_spi
                                    579 ;	src/spi_and_bit_banging.c:53: printf(">> SIN WAVE GENERATION COMPLETE\n\r");
      00225A 74 20            [12]  580 	mov	a,#___str_2
      00225C C0 E0            [24]  581 	push	acc
      00225E 74 30            [12]  582 	mov	a,#(___str_2 >> 8)
      002260 C0 E0            [24]  583 	push	acc
      002262 74 80            [12]  584 	mov	a,#0x80
      002264 C0 E0            [24]  585 	push	acc
      002266 12 25 B2         [24]  586 	lcall	_printf
      002269 15 81            [12]  587 	dec	sp
      00226B 15 81            [12]  588 	dec	sp
      00226D 15 81            [12]  589 	dec	sp
                                    590 ;	src/spi_and_bit_banging.c:54: break;
                                    591 ;	src/spi_and_bit_banging.c:56: case 'B':
      00226F 80 9D            [24]  592 	sjmp	00105$
      002271                        593 00102$:
                                    594 ;	src/spi_and_bit_banging.c:57: bit_bang_spi_init();
      002271 12 20 95         [24]  595 	lcall	_bit_bang_spi_init
                                    596 ;	src/spi_and_bit_banging.c:58: unsigned char result2 = take_data();
      002274 12 24 10         [24]  597 	lcall	_take_data
                                    598 ;	src/spi_and_bit_banging.c:59: bit_bang_spi(result2);
      002277 12 20 62         [24]  599 	lcall	_bit_bang_spi
                                    600 ;	src/spi_and_bit_banging.c:60: printf(">> SQUARE WAVE GENERATION COMPLETE\n\r");
      00227A 74 42            [12]  601 	mov	a,#___str_3
      00227C C0 E0            [24]  602 	push	acc
      00227E 74 30            [12]  603 	mov	a,#(___str_3 >> 8)
      002280 C0 E0            [24]  604 	push	acc
      002282 74 80            [12]  605 	mov	a,#0x80
      002284 C0 E0            [24]  606 	push	acc
      002286 12 25 B2         [24]  607 	lcall	_printf
      002289 15 81            [12]  608 	dec	sp
      00228B 15 81            [12]  609 	dec	sp
      00228D 15 81            [12]  610 	dec	sp
                                    611 ;	src/spi_and_bit_banging.c:61: spi_init();
      00228F 12 22 01         [24]  612 	lcall	_spi_init
                                    613 ;	src/spi_and_bit_banging.c:65: }
                                    614 ;	src/spi_and_bit_banging.c:75: }
      002292 02 22 0E         [24]  615 	ljmp	00105$
                                    616 	.area CSEG    (CODE)
                                    617 	.area CONST   (CODE)
                                    618 	.area CONST   (CODE)
      003014                        619 ___str_0:
      003014 7C 20 24 20 25 63      620 	.ascii "| $ %c"
      00301A 0A                     621 	.db 0x0a
      00301B 0D                     622 	.db 0x0d
      00301C 00                     623 	.db 0x00
                                    624 	.area CSEG    (CODE)
                                    625 	.area CONST   (CODE)
      00301D                        626 ___str_1:
      00301D 0A                     627 	.db 0x0a
      00301E 0D                     628 	.db 0x0d
      00301F 00                     629 	.db 0x00
                                    630 	.area CSEG    (CODE)
                                    631 	.area CONST   (CODE)
      003020                        632 ___str_2:
      003020 3E 3E 20 53 49 4E 20   633 	.ascii ">> SIN WAVE GENERATION COMPLETE"
             57 41 56 45 20 47 45
             4E 45 52 41 54 49 4F
             4E 20 43 4F 4D 50 4C
             45 54 45
      00303F 0A                     634 	.db 0x0a
      003040 0D                     635 	.db 0x0d
      003041 00                     636 	.db 0x00
                                    637 	.area CSEG    (CODE)
                                    638 	.area CONST   (CODE)
      003042                        639 ___str_3:
      003042 3E 3E 20 53 51 55 41   640 	.ascii ">> SQUARE WAVE GENERATION COMPLETE"
             52 45 20 57 41 56 45
             20 47 45 4E 45 52 41
             54 49 4F 4E 20 43 4F
             4D 50 4C 45 54 45
      003064 0A                     641 	.db 0x0a
      003065 0D                     642 	.db 0x0d
      003066 00                     643 	.db 0x00
                                    644 	.area CSEG    (CODE)
                                    645 	.area XINIT   (CODE)
